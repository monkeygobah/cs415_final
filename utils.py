...
def blur_contrast(image):
    ''' 
    Blur and increase contrast of image
    '''
...
def descrip_extraction(file, data_dict, preprocess_method):
    """ 
    ...
    if preprocess_method == None:
        ...
        cont_image = blur_image(image)
    elif preprocess_method == 'contrast':
        cont_image = increase_contrast(image)
    elif preprocess_method == 'both':
        cont_image = blur_contrast(image)       
...
''' 
populate data dict with percent white feature vectors
'''
